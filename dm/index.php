              ...
              <div class="main-menu text-right text-xl-right">
                <nav id="mobile-menu">
                  <ul id="menu-one-page-menu-2" class="menu">
                    ...
                    <li class="menu-item menu-item-type-custom menu-item-object-custom contact-us">
                      <a href="#">Contact</a>
                    </li>
                  </ul>
                </nav>
      ...
      <div class="slider-active">
        <div class="single-slider slider-bg d-flex align-items-center p-relative">
          <div class="slider-line" data-animation="fadeInRight" data-delay=".8s">
            <img src="img/bg/slider-line-new.png" alt="slider-line" />
          </div>
          <div class="slider-line2" data-animation="fadeInRight" data-delay=".4s">
            <img src="img/bg/slider-lineT.png" alt="slider-line" />
          </div>
          <div class="image-layer" style="background: url(img/banner-bg.png)"></div>
          <div class="container">
            <div class="row main-container-form">
              <!-- Text Container -->
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="slider-btn">
                            ...
                            <input type="hidden" id="sourceId" name="source" value="<?php if(isset($_GET['utm_source'])){ echo $_GET['utm_source']; } ?>" />
      ...
      <div class="container">
        ...
        <div class="row mt-0 align-items-center gap-5">
          <div class=" card-section" data-animation="fadeInDown animated" data-delay=".2s">
            ...
            <div class="card ">
              <img src="img/industries/B2B.png" alt="" />
              <p class="p-overlay">B2B</p>
              <div class="card__content">
                <p class="card__title">B2B</p>
                <p class="card__description">
                  Tailored B2B strategies to streamline operations, boost efficiency, and drive growth, ensuring your
                  business stays competitive and thrives in today's dynamic market
                </p>
              </div>
            </div>
            <div class="card ">
              <img src="img/industries/ecommerce.png" alt="" />
              <p class="p-overlay">E-commerce</p>
              <div class="card__content">
                <p class="card__title">E-commerce</p>
                <p class="card__description">


                  Targeted e-commerce marketing solutions to enhance customer experience, increase sales, and grow your
                  brand, helping you stay ahead in a fast-paced online landscape.
                </p>
              </div>
            </div>
            <div class="card ">
    ...
    <footer class="pt-10">
      <div class="footer-container">
        <div class="space-y-6 sm:max-w-md sm:mx-auto sm:text-center">
          ...
          <div class="button-container pulse-effect">

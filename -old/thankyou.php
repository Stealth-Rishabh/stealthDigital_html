...
<body>
  ...
  <nav class="navbar navbar-expand-lg">
    <div class="container">
      <a class="navbar-brand" href="#"><img src="img-webp/logo-l.webp" alt="logo-img" class="logo-img"></a>
  ...
  <footer class="footer-s1">
        ...
        <div class="footer-cr-container">
          ...
          <div class="p-right">
            <ul class="social-icons-s1  mb-0">
              ...
              <!-- <li>
                <a href="https://twitter.com/StealthtechST" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512">
                    <path
    ...
    <!-- <div class="whatsapp-icon">
            <a href="https://api.whatsapp.com/send?phone=tel:+91-918700181135&text=Hello" class="float whatsappChat"
                target="_blank">
